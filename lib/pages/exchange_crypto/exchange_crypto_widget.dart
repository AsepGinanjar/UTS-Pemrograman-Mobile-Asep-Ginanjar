...
class ExchangeCryptoWidget extends StatefulWidget {
  ...
  @override
  State<ExchangeCryptoWidget> createState() => _ExchangeCryptoWidgetState();
}

class _ExchangeCryptoWidgetState extends State<ExchangeCryptoWidget>
    with TickerProviderStateMixin {
  late ExchangeCryptoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExchangeCryptoModel());
