...
class ExchangeSellConfirmWidget extends StatefulWidget {
  const ExchangeSellConfirmWidget({
    super.key,
    this.nameCoin,
  });
  ...
  @override
  State<ExchangeSellConfirmWidget> createState() =>
      _ExchangeSellConfirmWidgetState();
}

class _ExchangeSellConfirmWidgetState extends State<ExchangeSellConfirmWidget>
    with TickerProviderStateMixin {
  late ExchangeSellConfirmModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ExchangeSellConfirmModel());
